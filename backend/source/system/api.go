...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		{ApiGroup: "api", Method: "POST", Path: "/createApi", Description: "创建api"},
		{ApiGroup: "api", Method: "POST", Path: "/deleteApi", Description: "删除Api"},
		{ApiGroup: "api", Method: "POST", Path: "/updateApi", Description: "更新Api"},
		{ApiGroup: "api", Method: "POST", Path: "/getApiList", Description: "获取api列表"},
		{ApiGroup: "api", Method: "POST", Path: "/getAllApis", Description: "获取所有api"},
		{ApiGroup: "api", Method: "POST", Path: "/getApiById", Description: "获取api详细信息"},
		{ApiGroup: "api", Method: "DELETE", Path: "/deleteApisByIds", Description: "批量删除api"},
		{ApiGroup: "api", Method: "GET", Path: "/syncApi", Description: "获取待同步API"},
		{ApiGroup: "api", Method: "GET", Path: "/getApiGroups", Description: "获取路由组"},
		{ApiGroup: "api", Method: "POST", Path: "/enterSyncApi", Description: "确认同步API"},
		{ApiGroup: "api", Method: "POST", Path: "/ignoreApi", Description: "忽略API"},
