...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "888", V1: "/deleteApi", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/updateApi", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/getAllApis", V2: "POST"},
		{Ptype: "p", V0: "888", V1: "/deleteApisByIds", V2: "DELETE"},
		{Ptype: "p", V0: "888", V1: "/syncApi", V2: "GET"},
		...
		{Ptype: "p", V0: "8881", V1: "/getApiById", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/deleteApi", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/updateApi", V2: "POST"},
		{Ptype: "p", V0: "8881", V1: "/getAllApis", V2: "POST"},
		...
		{Ptype: "p", V0: "9528", V1: "/getApiById", V2: "POST"},
