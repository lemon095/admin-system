        ...
        <template #wrapper>
            <el-card class="box-card">
                ...
                <el-row :gutter="10" class="mb8">
                    ...
                    <el-col :span="1.5">
                        <el-button
                                v-permisaction="['admin:item:remove']"
                                type="danger"
                                icon="el-icon-delete"
                                size="mini"
                                :disabled="multiple"
                ...
                <el-table v-loading="loading" :data="itemList" @selection-change="handleSelectionChange">
                    <el-table-column type="selection" width="55" align="center"/><el-table-column label="道具id" align="center" prop="itemId"
                                                 :show-overflow-tooltip="true"/><el-table-column label="道具类型" align="center" prop="type"
                                                 :show-overflow-tooltip="true"/><el-table-column label="道具名称" align="center" prop="name"
                                                 :show-overflow-tooltip="true"/><el-table-column label="道具描述" align="center" prop="desc"
                                                 :show-overflow-tooltip="true"/><el-table-column label="图片地址" align="center" prop="icon"
                                                 :show-overflow-tooltip="true"/><el-table-column label="扩展属性" align="center" prop="extend"
                ...
                <el-dialog :title="title" :visible.sync="open" width="500px">
                    <el-form ref="form" :model="form" :rules="rules" :disabled="form.mode === 'view'" label-width="80px">
                                    ...
                                    <el-form-item label="道具描述" prop="desc">
                                        <el-input v-model="form.desc" placeholder="道具描述"
                                                      />
                                    </el-form-item>
